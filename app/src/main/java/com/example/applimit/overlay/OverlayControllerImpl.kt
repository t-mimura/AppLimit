...
class OverlayControllerImpl @Inject constructor(
    ...
    override fun showWarningOverlay(
        ...
        val message = context.getString(
            com.example.applimit.R.string.warning_message,
            appName,
            usedMinutes
        )
    ...
    override fun showCooldownOverlay(
        ...
        hideOverlay()
        val message = context.getString(
            com.example.applimit.R.string.cooldown_message,
            appName,
            remainingMinutes
        )
        showOverlay(message, onExtend, onDismiss)
        ...
        return LinearLayout(context).apply {
            ...
            addView(
                Button(context).apply {
                    text = context.getString(com.example.applimit.R.string.extend_button)
            ...
            addView(
                Button(context).apply {
                    text = context.getString(com.example.applimit.R.string.dismiss_button)
